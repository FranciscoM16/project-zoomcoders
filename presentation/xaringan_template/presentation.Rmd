...
author: "Zoomcoders <br> Alex Milchev, Francisco Mendonca, Jiaqi Gao and Yingying Xiao"
...
```{r include=FALSE}
style_xaringan(
  title_slide_background_image = "img/ocean.jpg"
)
```

class: center, middle

## Goal: To investigate how the development of a country can impact the quality of life of its citizens
